...
namespace Colaboro.Droid.CoDroidControls
{
    public sealed class CoDroidCameraView : ViewGroup, ISurfaceHolderCallback
    {
        ...
        public CoDroidCameraView(Context context)
            : base(context)
        {
